...
then
  ...
  mongoimport --db socobo_dev --collection recipeIngredient --drop --file ./data/create-recipe-ingredients.json --jsonArray
...
then
  ...
  mongoimport --db socobo_test --collection recipeIngredient --drop --file ./data/create-recipe-ingredients.json --jsonArray
