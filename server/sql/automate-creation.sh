...
then
  ...
  mongoimport --db socobo_dev --collection recipes --drop --file ./dev/create-recipe.json
...
then
  ...
  mongoimport --db socobo_test --collection recipes --drop --file ./test/create-recipe.json
