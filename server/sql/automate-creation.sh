...
then
  ...
  mongoimport --db socobo_dev --collection socoboUser --drop --file ./dev/create-socoboUser.json
...
then
  ...
  mongoimport --db socobo_test --collection socoboUser --drop --file ./test/create-socoboUser.json
