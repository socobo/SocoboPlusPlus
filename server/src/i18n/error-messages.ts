export const ERROR_MESSAGES: any = {
  ...
  "fooditem.category.not.found": "Fooditem Category not found",
  "fooditem.template.not.found": "Fooditem Template not found",
  "fooditem.unit.not.found": "Fooditem Unit not found",
